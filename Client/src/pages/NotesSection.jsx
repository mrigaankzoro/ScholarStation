...
const NotesSection = () => {
  return (
    <div className="mt-10 w-11/12 mx-auto max-w-maxContent grid grid-cols-1 md:grid-cols-3 gap-6 text-white">
      {/* Notes Block */}
      <Link to="/filter-notes" className="flex flex-col items-center bg-richblack-800 p-6 rounded-lg text-center hover:scale-105 transition-transform duration-200">
